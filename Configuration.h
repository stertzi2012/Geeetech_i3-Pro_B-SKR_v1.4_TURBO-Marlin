...
#define STRING_CONFIG_H_AUTHOR "(stertzi2012, default config)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "i3 Stertz"
 ...
 */
#define NOZZLE_TO_PROBE_OFFSET { -42, -8, -0.8 }
